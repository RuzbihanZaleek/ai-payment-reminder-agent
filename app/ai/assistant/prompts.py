...
INTENT_DETECTION_PROMPT = (
    ...
    "\n"
    "For CREATE_CONTRACT extract 'person' (customer name), 'amount' (total), "
    "'daily_amount' and 'phone' (the customer's WhatsApp number). These may be "
    "provided across several messages -- extract every field that appears "
    "anywhere in the conversation so far. For APPROVE_PAYMENT/REJECT_PAYMENT "
    "extract 'payment_id' if a specific payment is named.\n"
    "\n"
